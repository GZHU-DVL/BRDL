...
if __name__ == '__main__':
    ...
    #data
    parser.add_argument('--phase', type=str, default='incre', choices=['jointtrain', 'increOurs', 'jointeval', 'increeval'])
    ...
    if args.phase=='jointtrain':
        ...
        train(args)
    elif args.phase=='jointeval' or args.phase=='increeval':
